...
@section('content')
    ...
    <div class="flex justify-center mt-10">
        <div class="w-full">
            <form action="{{ route('business.upload') }}" method="POST" enctype="multipart/form-data" id="create-business"
                ...
                <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    ...
                    <input type="text" name="title" id="titles" value="{{ old('title') }}" required
                ...
                <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-6">
                    ...
                    <label for="image"
                        ...
                        <div class="flex flex-col items-center justify-center pt-5 pb-6">
                            <svg id = "main-upload" class="w-8 h-8 mb-4 text-gray-500 dark:text-gray-400" aria-hidden="true"
                ...
                <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-6 h-auto overflow-hidden">
                    ...
                    <label for="file"
                        ...
                        <div class="flex flex-col items-center justify-center pt-5 pb-6 h-auto overflow-hidden">
                            <svg id="file-upload" class="w-8 h-8 mb-4 text-gray-500 dark:text-gray-400" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M13 13h3a3 3 0 0 0 0-6h-.025A5.56 5.56 0 0 0 16 6.5 5.5 5.5 0 0 0 5.207 5.021C5.137 5.017 5.071 5 5 5a4 4 0 0 0 0 8h2.167M10 15V6m0 0L8 8m2-2 2 2" />
                            </svg>
                        ...
                        <input id="file" type="file" class="hidden" name="file[]" multiple required
                            accept="image/*" />
                    </label>
                    @error('file')
                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                ...
                <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    ...
                    <input type="tel" id="phone" name="phone" pattern="08\d{8,}"
                        title="The number must start with 08 and have at least 10 digits" value="{{ old('phone') }}"
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        required>
                    @error('phone')
                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                ...
                <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    ...
                    <input type="number" name="nominal" id="nominal" required value="{{ old('nominal') }}"
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                    @error('nominal')
                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
            ...
            submitHandler: function(form) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        Swal.fire('Success!', 'Your business has been submitted', 'success').then((
                            result) => {
                            form.submit();
                        });
                    }
