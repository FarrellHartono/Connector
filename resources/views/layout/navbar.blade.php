...
<nav class="bg-white dark:bg-gray-900 w-full px-1 z-20 top-0 border-b border-gray-200 dark:border-gray-600 flex justify-evenly">
    ...
    <div class="items-center justify-center flex-grow hidden md:flex" id="navbar-sticky">
        <ul class="hidden md:flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-12 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
                <a href="{{ route('home') }}"
        ...
        <button class="space-y-1 group md:hidden">
            ...
            <ul class="bg-[#252525] w-screen pb-10 absolute -top-0 right-0 duration-150 flex flex-col space-y-3 justify-end">
                <li>
                    <a href="{{ route('home') }}"
                       class=""
                       aria-current="page">
