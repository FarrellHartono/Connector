  ...
  <div class="justify-self-center bg-gray-300 w-[400px] h-[400px] p-6 rounded-lg">
    ...
    <form action="{{ route('loginProcess') }}" method="Post" class="max-w-sm mx-auto">
      ...
      <div  class="grid">
        ...
        <button type="submit" class="justify-self-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login</button>
