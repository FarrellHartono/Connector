...
<div class="grid bg-gradient-to-b from-[#0370A3] to-[#A1F3CD] h-screen  w-auto h-full p-20">
  <div class="justify-self-center bg-gray-300 w-[400px] h-[700px] p-6 rounded-lg">
    <h2 class="text-2xl font-bold text-center mb-6">Sign Up</h2>
    <form action="{{ route('signUpProcess') }}" method="Post" class="max-w-sm mx-auto">
      @csrf
      <div  class="grid">
        <div class="mb-5">
        ...
        <div class="mb-5">
          ...
          <span id="email-error" class="text-red-500 mt-1 hidden">Email sudah terdaftar</span>
        </div>
